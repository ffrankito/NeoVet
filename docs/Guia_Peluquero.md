...
- **Tipo de pelaje:** Largo, corto, rizad, doble, etc.
- **Dificultades del pelaje:** Nudos frecuentes, sensibilidad, etc.
- **Tiempo estimado:** Cuántos minutos te llevaría normalmente
- **Notas de comportamiento:** Cosas que debés saber (ej: "No le gusta que le toquen las patas", "Muy nervioso con secador")
...
💡 **Por qué importa:** Este perfil te ayuda a prepararte para cada sesión. Si sabés que un perro tiene nudos frecuentes, preparas champú específico. Si es nervioso, tenés cuidado con el volumen del secador.
...
### Desde el Turno
- Abrí el turno
- Botón "Registrar sesión" o "Completar"
- Se abre un formulario

### Paso 1: Fotos Antes
- Botón "+ Agregar fotos"
- Subí fotos del estado del pelaje ANTES de empezar
- Ayuda a documentar el trabajo y detectar problemas (nudos, heridas, sarna)
...
- ☐ Problemas de piel (descamación, enrojecimiento, picazón)
- ☐ Uñas largas / Sin cortar
- ☐ Otros hallazgos

**Si marcás algo, escribí una nota:**
- Ej: "Nódulo pequeño en flanc izquierdo, debería verlo el vet"
- Ej: "Garrapatas en el lomo, bastantes"
- Ej: "Otitis bilateral, olor fuerte, sebosos"
...
- Tarjeta
- Transferencia
- (Lo que acordaron con el cliente)

### Paso 7: Guardar
- Hacé clic en "Guardar sesión"
- Listo. El turno se marca como completado
- El ingreso se registra automáticamente en la caja (Paula no necesita tocarlo)
...
**Paula y los vets necesitan saberlo** porque:
- Pueden agendar al cliente con el vet para evaluación
- Pueden detectar patrones (ej: "Los últimos 3 bulldog tuvieron otitis — quizá hay un problema ambiental")
- Pueden ofrecerle al cliente servicios (ej: champú medicado, tratamiento de parásitos)
- En emergencias, esa información puede salvar una vida

**En el futuro, el sistema va a poder alertar automáticamente** al vet si encontrás algo importante. Por eso es crítico que lo registres bien.

💡 **Por qué importa:** Vos sos los ojos de la clínica. Pasás más tiempo tocando el cuerpo del paciente que nadie. Si detectás algo, el sistema necesita saberlo.

---

## 7. Cancelar un Turno

Si el cliente no se presenta o cancela.

**Desde el turno:**
- Botón "Cancelar" o "Marcar como no se presentó"
- Elegí el motivo: Cliente solicitó cancelación / No se presentó / Razón médica / Otro
- Escribí una nota si es necesario (ej: "La mascota estaba enferma")
- Guardá

**Qué pasa:**
- El turno se marca como cancelado/no presentó
- El cliente recibe un email informándole la cancelación (si lo hizo admin, no vos)
- El turno no afecta tu agenda ni la caja
...
**Paula cierra la caja al final del día.** Ella verifica que los montos cuadren. Si contó $150 en efectivo y el sistema dice $150, perfecto. Si hay diferencia, lo investiga.

💡 **Tu rol:** Asegurate de:
- Indicar el método de pago correcto cuando guardas la sesión
- No cambiar precios caprichosamente (solo si hay una razón real)
- Confirmar el registro al guardar
...
Al final del día:
1. **Completaste todas tus sesiones** en el sistema (fotos, hallazgos, dificultad, precio, pago)
2. **Paula cierra la caja** — verifica que cuadre con los ingresos registrados
3. **Todo queda grabado** — en la historia de cada paciente, en el historial de caja, en el registro de la clínica

---

## El Panorama General — Por Qué Importa Este Sistema
...
- [ ] ¿Subí fotos antes y después?
- [ ] ¿Marqué los hallazgos que encontré?
- [ ] ¿Seleccioné el nivel de dificultad correcto?
- [ ] ¿Revisé que el precio sea el justo?
- [ ] ¿Indiqué el método de pago del cliente?
- [ ] ¿Guardé la sesión?

Listo. Gracias por mantener el sistema completo.
